        ...
        for sub in expired_subs:
            try:
                ...
                kb = InlineKeyboardMarkup(inline_keyboard=[
                    [InlineKeyboardButton(text="💳 Obunani yangilash", callback_data="check_permissions")] # Redirect to start/check logic
                ])
                ...
                logging.info(f"Kicked user {sub.user_id} due to expiration.")
